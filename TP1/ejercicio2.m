...
pos_global = pos_global(1:2,:);


figure(2)
hold on
scatter(pos_robot(1),pos_robot(2),200,'filled');
scatter(pos_sensor(1),pos_sensor(2),100,'filled');
scatter(pos_global(1,:),pos_global(2,:),20,'filled');
axis('equal')
grid on;
