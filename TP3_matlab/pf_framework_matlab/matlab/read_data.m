function data = read_data(filename)
    ...
    odom = struct('r1', nan, 'r2', nan, 't', nan);
    sensor = struct('id', nan, 'range', nan, 'bearing', nan);
    
    data.timestep.sensor = struct('id', nan, 'range', nan, 'bearing', nan);
    data.timestep.odometry = struct('r1', nan, 'r2', nan, 't', nan);
